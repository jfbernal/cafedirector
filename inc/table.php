...
<?php
$sql = "SELECT * FROM  training_requests JOIN trainings ON trainings.trainingID= training_requests.trainingID WHERE storeID = '$storeID'";
$result = mysqli_query($conn, $sql);
$count = mysqli_num_rows($result);
if ($count >= 1){
  ?>
  <!-- <h1>This is a visible heading</h1>
  <h1 id="myP" class="hidden232"> fede This is a hidden heading</h1>
...
<table id="DataTables" class="table table-striped table-bordered" cellspacing="0" width="100%">
 ...
 foreach ($result as $row) {
   echo '<tr>';
     ...
     echo "<td id='bodycolumn2' >". $row['training_status']. "</td>";
    ...
    //  echo "<button type='button' onclick='". $row['trainingID']."'>Click Me!</button>";
     echo "</td>";
   echo '</tr>';
 }
 }
